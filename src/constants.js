...
export const SETUP_CODE = `${BTS_CODE};${BLOCK_MAP_CODE}`;

export const sliderToValue = (val) => (val >= 11 ? null : val);
export const valueToSlider = (val) => (val === null || val === Infinity ? 11 : val);
